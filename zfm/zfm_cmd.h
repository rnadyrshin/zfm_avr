...
#define ZFM_TimeOutMs           1500      // Таймаут ожиания ответа от дисплея в мс
#define ZFM_STARTCODE           0xEF01

#define ZFM_GetDataBlock_DEBUG  0       // Режим отладки чтения блока данных из ZFM (не пишет ничего в выходной буфер)
...
typedef enum
{
  ...
  HiSpeedSearch         = 0x1B, // Команда отсутствует в документации. Не реализована
